...
const DIAGNOSTICS: &[DiagnosticDescriptor] = &[
    ...
    DiagnosticDescriptor {
        code: "JV_REGEX_I001",
        title: "正規表現モードとフラグが混同されています",
        help: "モード `m` を省略するか `[match]` を明示して、フラグ `m` との混同を避けてください。",
        severity: DiagnosticSeverity::Information,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_I002",
        title: "正規表現モードがあいまいです",
        help: "置換目的なら `//` を追加し、判定目的ならモード `m` を明示してください。",
        severity: DiagnosticSeverity::Information,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_I003",
        title: "大容量入力での配列化を避けるべきです",
        help: "大きなテキストでは `Stream` のまま処理するか、`limit` などで逐次処理してください。",
        severity: DiagnosticSeverity::Information,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_I004",
        title: "小規模入力では `as List` を検討してください",
        help: "少量の結果であれば `as List` でリスト化すると操作が容易になります。",
        severity: DiagnosticSeverity::Information,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_I005",
        title: "`Stream<MatchResult>` の再利用はできません",
        help: "複数回利用する場合は `as List` で結果を素材化してください。",
        severity: DiagnosticSeverity::Information,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_E101",
        title: "未知の正規表現フラグが指定されました",
        help: "利用可能なフラグは `i`, `m`, `s`, `u`, `d`, `x`, `l`, `c` です。",
        severity: DiagnosticSeverity::Error,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_E102",
        title: "ラムダ置換の戻り値が String ではありません",
        help: "`toString()` で文字列へ変換するか `String.valueOf(...)` を利用してください。",
        severity: DiagnosticSeverity::Error,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_E103",
        title: "排他的な正規表現フラグが同時に指定されました",
        help: "競合するフラグのどちらかを削除してください。",
        severity: DiagnosticSeverity::Error,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_W003",
        title: "ラムダ置換内で外側の変数を変更しています",
        help: "副作用を避けるため、ラムダ内部で独立した変数を利用するか同期機構を導入してください。",
        severity: DiagnosticSeverity::Warning,
    },
    DiagnosticDescriptor {
        code: "JV_REGEX_S001",
        title: "正規表現結果が外部 API へ直接渡されています",
        help: "外部システムへ送信する前にサニタイズや検証を行ってください。",
        severity: DiagnosticSeverity::Warning,
    },
    DiagnosticDescriptor {
        code: "JV3199",
