...
StatementList = (CommentStatement | UnitTypeDefinition | AssignmentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | ClassDeclaration | WhenStatement | ForStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement | UseStatement | DeferStatement | SpawnStatement | LogBlockExpression)*
...
Expression = ExpressionToken | UnitLiteral | LogBlockExpression
