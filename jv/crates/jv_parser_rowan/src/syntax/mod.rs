...
InitializerClause = Assign (DoublebraceBlock | Expression)
...
DoublebraceBlock = LeftBrace LeftBrace StatementList RightBrace RightBrace
...
Expression = ExpressionToken | DoublebraceBlock
PackageKw = 'package'
ImportKw = 'import'
ValKw = 'val'
VarKw = 'var'
