...
StatementList = (CommentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | ClassDeclaration | IfStatement | WhenStatement | ForStatement | WhileStatement | DoWhileStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement)*
