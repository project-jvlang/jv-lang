...
StatementList = (CommentStatement | AssignmentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | TestDeclaration | ClassDeclaration | WhenStatement | ForStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement | UseStatement | DeferStatement | SpawnStatement)*
...
TestDataset = LeftBracket (TestDatasetRow (Comma TestDatasetRow)*)? RightBracket
...
TestParameterList = LeftParen (TestParameter (Comma TestParameter)*)? RightParen
