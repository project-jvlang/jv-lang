...
StatementList = (CommentStatement | AssignmentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | ClassDeclaration | IfStatement | WhenStatement | ForStatement | WhileStatement | DoWhileStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement | UseStatement | DeferStatement | SpawnStatement)*
CommentStatement = LineComment | BlockComment
AssignmentStatement = AssignmentTarget Assign Expression
AssignmentTarget = Identifier (Dot Identifier)*
