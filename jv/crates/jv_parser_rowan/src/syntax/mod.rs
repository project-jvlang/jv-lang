...
Modifier = Identifier
FunctionDeclaration = AnnotationList? ModifierList? FunKw Identifier TypeParameterList? FunctionParameterList FunctionReturnType? WhereClause? (Block | Assign Expression | Arrow Expression)
