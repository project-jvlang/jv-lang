...
StatementList = (CommentStatement | AssignmentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | ClassDeclaration | WhenStatement | ForStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement | UseStatement | DeferStatement | SpawnStatement | LogBlockExpression)*
...
Expression = ExpressionToken | LogBlockExpression
PackageKw = 'package'
ImportKw = 'import'
ValKw = 'val'
VarKw = 'var'
