...
StatementList = (CommentStatement | UnitTypeDefinition | AssignmentStatement | ValDeclaration | VarDeclaration | FunctionDeclaration | ClassDeclaration | WhenStatement | ForStatement | ReturnStatement | ThrowStatement | BreakStatement | ContinueStatement | UseStatement | DeferStatement | SpawnStatement)*
...
Expression = ExpressionToken | UnitLiteral
PackageKw = 'package'
ImportKw = 'import'
ValKw = 'val'
VarKw = 'var'
